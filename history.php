<?php
    ...
    if (isset($_SESSION["login_as"])) {
        ...
        foreach($history_array as $p) {
            $productid = intval($p);
            $company = intval($productid/100);

            if (array_key_exists("company" . $company, $company_products)) {
              global $products;
              $products = $company_products["company" . $company];
              foreach($products as $product) {
                if ($product[0] == $p) {
                    array_push($final_array, $product);
                    break;
                }
              }  
            } else {
                ...
                $company_products["company" . $company] = $product_array;
...
<?php include 'header.php';?>
    ...
    <div class="jumbotron feature">
        <div class="container">
            <h1><span class="glyphicon glyphicon-knight"></span> Last 10 Viewed Products</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <?php 
                foreach($final_array as $index => $product) {
